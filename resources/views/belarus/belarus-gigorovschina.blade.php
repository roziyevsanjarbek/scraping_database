    ...
    <script>
        ...
        fileInput.addEventListener('change', async function () {
            ...
            try {
                ...
                const response = await fetch('http://localhost:8000/api/belarus-gigorovschina/import', {
                    method: 'POST',
                    body: formData
                });
        ...
        downloadBtn.addEventListener('click', function () {
            ...
            let url = new URL('http://localhost:8000/api/belarus-gigorovschina/export');
        ...
        async function loadBelarusData(page = 1) {
            ...
            let url = new URL('http://localhost:8000/api/belarus-gigorovschina');
